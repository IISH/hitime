<html>
        <head>
	<title>Strikes Visualization</title>
	...
	<td width=70% valign=top>
		...
		<div id="visual" style="width:100%;border:1px solid;float:left;">
		...
		<div id="refine" style="text-align:center;vertical-align:middle;width:100%;float:left;">%%refine%%</div>
		%%events%%
	</td>
	<td width=10%>&nbsp;</td>
	</tr>
