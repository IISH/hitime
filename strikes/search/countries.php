...
<head>
	...
	<link rel="stylesheet" media="screen" href="/evergreen<?=$web_root?>../css/querybox.css" type="text/css" />
	<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/dojo/1.2.0/dojo/dojo.xd.js"></script>
	<script type="text/javascript" src="/evergreen<?=$web_root?>../js/marumushi.widget.querybox.js"></script>
</head>
...
<body>
	...
	<script type="text/javascript">
		...
		var qbox 				= new marumushi.widget.QueryBox('/evergreen/offline/cgi-bin/searchcountry.cgi?q=','qbox');
		qbox.defaultMessage 	= "Country search ...";
