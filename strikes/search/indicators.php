...
<head>
	...
	<link rel="stylesheet" media="screen" href="<?=$web_root?>../css/indicators.css" type="text/css" />
...
<body>
	...
	<script type="text/javascript">
		...
		var qbox 				= new marumushi.widget.QueryBox('/cgi-bin/searchindicators.cgi?q=','qbox');
		qbox.defaultMessage 	= "Indicators search ...";
